...
SYSTEM_INSTRUCTION = (
    ...
    "When the user asks about spends or expenses for a specific month of the "
    "current year, use the get_spends_by_month tool with the month as an integer "
    "(1 = January, 2 = February, ..., 12 = December).\n"
    "When the user says 'this month' use the current month based on today's date.\n"
    "When the user asks about spends for an entire year, annual totals, or "
    "monthly spends of a past/specific year (e.g. 'gastos mensuales del 2022'), "
    "use the get_spends_by_year tool with the year number. It returns the full "
    "list of spends for that year — you can then group or filter them by month "
